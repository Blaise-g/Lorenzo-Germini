import {
  ...
  export const RESUME_DATA: ResumeData = {
    ...
    summary: "Results-driven AI Engineer with a track record of building and deploying Generative AI solutions that deliver tangible business value, demonstrating both technical leadership and product acumen. I have demonstrated my ability to collaborate with cross-functional teams to deliver data-driven insights and create business value in fast-paced environments in both Pharma and Startup sectors. Driven by insatiable curiosity and a passion for learning, I continuously improve my skillset through dedicated self-development. In my free time, I engage in sports, work on personal projects, and voraciously consume content on tech entrepreneurship, personal finance, and biohacking.",
