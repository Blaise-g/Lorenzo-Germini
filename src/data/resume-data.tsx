...
export const RESUME_DATA = {
  ...
  about:
    "Data Scientist with expertise in pharma and healthcare, passionate about leveraging data-driven insights to solve complex problems and create meaningful impact on people's lives and the environment.",
  summary:
